...
namespace Module.MES.Features.SystemConfig.ViewModels;

public sealed class MesSystemConfigViewModel : ViewModelProperties
{
    private static readonly string MesSystemConfigFilePath =
        MesConfigRegistry.MesSystemConfigFilePath;
    ...
    public MesSystemConfigViewModel()
    {
