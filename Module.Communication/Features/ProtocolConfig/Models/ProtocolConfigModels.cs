...
namespace Module.Communication.Features.ProtocolConfig.Models
{
    ...
    public sealed class ProtocolCommandConfig : ViewModelProperties
    {
        ...
        private new bool SetField<T>(ref T field, T value, bool raiseStateChanges = true, [CallerMemberName] string? propertyName = null)
        {
