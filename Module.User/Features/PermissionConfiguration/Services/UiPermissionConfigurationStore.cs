using System.IO;
using Module.User.Configuration;
...
public static class UiPermissionConfigurationStore
{
    ...
    {
        if (!File.Exists(UserConfigRegistry.UiPermissionsFilePath))
        {
        ...
        try
        {
            string json = File.ReadAllText(UserConfigRegistry.UiPermissionsFilePath);
    ...
    public static void SaveCatalog(UiPermissionCatalog catalog)
    {
        ...
        Directory.CreateDirectory(UserConfigRegistry.ConfigDirectory);
        string json = JsonSerializer.Serialize(normalized, JsonOptions);
        File.WriteAllText(UserConfigRegistry.UiPermissionsFilePath, json);
    }
    ...
    private static string MigrateLegacyKey(string key)
    {
        ...
        return normalizedKey
            .Replace(
                "Module.User.Views.AccountManagementView",
                "Module.User.Features.AccountManagement.Views.AccountManagementView",
