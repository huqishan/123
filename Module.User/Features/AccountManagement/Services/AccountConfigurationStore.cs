...
public static class AccountConfigurationStore
{
    ...
    {
        if (!File.Exists(UserConfigRegistry.AccountsFilePath))
        {
        ...
        try
        {
            string json = File.ReadAllText(UserConfigRegistry.AccountsFilePath);
    ...
    public static void SaveCatalog(AccountCatalog catalog)
    {
        ...
        File.WriteAllText(UserConfigRegistry.AccountsFilePath, json);
    }
    ...
    public static string EncryptPassword(string password)
    {
        ...
        return PasswordProtector.Protect(password);
    }
    ...
    private static bool VerifyPassword(string password, string encryptedPassword)
    {
        ...
        return PasswordProtector.Verify(password, encryptedPassword);
    }
